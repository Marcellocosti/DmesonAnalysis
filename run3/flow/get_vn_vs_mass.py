...
def get_vn_vs_mass(fitConfigFileName, centClass, inFileName,
    ...
    fMassTemplTotFuncts = [None]*len(ptMins) if fitConfig.get('IncludeTempls') and (particleName == 'Dplus' or particleName == 'Ds') else []
